...
class Command(BaseCommand):
    help = 'Синхронизация только учебных групп из расписания mpt.ru'
    ...
    def handle(self, *args, **options):
        ...
        result = service.sync_groups(dry_run=options['dry_run'])
        self.stdout.write(self.style.SUCCESS(f'groups: {result.as_dict()}'))
